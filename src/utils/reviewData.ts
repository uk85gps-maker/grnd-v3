...
const DEFAULT_PYRAMID: PyramidLayer[] = [
  ...
  { id: 5, name: 'Physical Product', status: 'building', activeActions: '', evidence: '' },
  { id: 6, name: 'Presence', status: 'building', activeActions: '', evidence: '' },
  { id: 7, name: 'Inner Game', status: 'building', activeActions: '', evidence: '' },
  { id: 8, name: 'Income & Direction', status: 'building', activeActions: '', evidence: '' },
